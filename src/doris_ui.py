...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sp_max_distance = QtWidgets.QSpinBox(self.centralwidget)
        self.sp_max_distance.setObjectName("sp_max_distance")
        self.horizontalLayout_18.addWidget(self.sp_max_distance)
